...
public class responseQuestionInputNumber implements KvmSerializable {
    
    public float oneAnswer;
    public boolean oneAnswerSpecified;
    ...
    public responseQuestionInputNumber(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject.hasProperty("oneAnswer"))
        {
            ...
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                ...
                oneAnswer = Float.parseFloat(j.toString());
            }else if (obj!= null && obj instanceof Number){
                oneAnswer = (Integer) obj;
            }
        }
        if (soapObject.hasProperty("oneAnswerSpecified"))
        {
            Object obj = soapObject.getProperty("oneAnswerSpecified");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                oneAnswerSpecified = Boolean.parseBoolean(j.toString());
            }else if (obj!= null && obj instanceof Boolean){
                oneAnswerSpecified = (Boolean) obj;
            }
        }
