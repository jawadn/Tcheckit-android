...
public class mobileApplication implements KvmSerializable {
    
    public long id;
    public boolean idSpecified;
    public String iphoneApnsCert;
    public String name;
    public String passwordApnsCert;
    ...
    public mobileApplication(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("iphoneApnsCert"))
        {
            Object obj = soapObject.getProperty("iphoneApnsCert");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                iphoneApnsCert = j.toString();
            }else if (obj!= null && obj instanceof String){
                iphoneApnsCert = (String) obj;
            }
        }
        ...
        if (soapObject.hasProperty("passwordApnsCert"))
        {
            Object obj = soapObject.getProperty("passwordApnsCert");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                passwordApnsCert = j.toString();
            }else if (obj!= null && obj instanceof String){
                passwordApnsCert = (String) obj;
            }
        }
    ...
    public Object getProperty(int arg0) {
        switch(arg0){
            ...
            case 1:
                return idSpecified;
            case 2:
                return iphoneApnsCert;
            case 3:
                return name;
            case 4:
                return passwordApnsCert;
            case 5:
                return dateCreated;
            case 6:
