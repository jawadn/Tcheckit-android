...
public class userAccount implements KvmSerializable {
    ...
    public userAccount(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("onePerson"))
        {
            SoapObject j = (SoapObject)soapObject.getProperty("onePerson");
            onePerson =  new person (j);
