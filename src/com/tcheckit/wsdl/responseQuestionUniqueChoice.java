...
public class responseQuestionUniqueChoice implements KvmSerializable {
    
    public choiceQuestion oneChoice;
    ...
    public responseQuestionUniqueChoice(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject.hasProperty("oneChoice"))
        {
            SoapObject j = (SoapObject)soapObject.getProperty("oneChoice");
            oneChoice =  new choiceQuestion (j);
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        switch(index){
            case 0:
                info.type = choiceQuestion.class;
                info.name = "oneChoice";
                break;
            case 1:
