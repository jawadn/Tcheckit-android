...
public class questionInputNumber implements KvmSerializable {
    
    public String unavailabilityLabel;
    ...
    public questionInputNumber(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject.hasProperty("unavailabilityLabel"))
        {
            Object obj = soapObject.getProperty("unavailabilityLabel");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) obj;
                unavailabilityLabel = j.toString();
            }else if (obj!= null && obj instanceof String){
                unavailabilityLabel = (String) obj;
            }
        }
