...
public class pageContent implements KvmSerializable {
    
    public long id;
    public boolean idSpecified;
    public VectorpageElement listPageElement;
    ...
    public pageContent(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("listPageElement"))
        {
            SoapObject j = (SoapObject)soapObject.getProperty("listPageElement");
            listPageElement = new VectorpageElement(j);
        }
