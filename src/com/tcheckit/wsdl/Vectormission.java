...
public class Vectormission extends Vector<mission> implements KvmSerializable {
    
    
    public Vectormission(){}
    
    public Vectormission(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
